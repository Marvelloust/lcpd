...
// Fetch newsletter subscriptions from the database
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($row['email']); ?></td> <!-- Use htmlspecialchars for safety -->
                                <td><?php echo date('D, jS Y', strtotime($row['created_at'])); ?></td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
